...
// client: md-condesa · version: 2026-09-22+e24ababc7137
...
export const CLIENT: ClientConfig = {
  ...
  "copy": {
    ...
    "noShowEs": "¡Hola{who}! Te esperábamos en tu clase de prueba 🥋 No pasa nada, ¿la reagendamos? {cta}",
    "noShowEn": "Hi{who}! We missed you at your trial class 🥋 No worries — want to reschedule? {cta}",
    "noShowD3Es": "¡Hola{who}! Seguimos con tu lugar apartado para tu clase de prueba gratis en MD Condesa 🥋 {cta}",
